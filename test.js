...
(0, globals_1.describe)("generateHTML", function () {
    (0, globals_1.it)("should save the generated HTML to a file", function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 2:
                    savedHtml = _a.sent();
                    (0, globals_1.expect)(savedHtml).toBeTruthy();
                    return [2 /*return*/];
            }
        });
    }); });
